var p2DebugDraw = (function () {
    ...
    var __egretProto__ = p2DebugDraw.prototype;
    __egretProto__.setSprite = function (sprite) {
        this.sprite = sprite;
    };
    __egretProto__.drawDebug = function () {
    ...
    __egretProto__.drawConvex = function (shape, b) {
    ...
    __egretProto__.drawCircle = function (shape, b) {
        var color = this.getColor(b);
        var g = this.sprite.graphics;
        g.lineStyle(1, color);
        g.beginFill(color, 0.5);
    ...
    __egretProto__.drawPlane = function (shape, b) {
    ...
    __egretProto__.getColor = function (b) {
        var color = this.COLOR_D_SLEEP;
...
p2DebugDraw.prototype.__class__ = "p2DebugDraw";
